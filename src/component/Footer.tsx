...
<footer className=" flex flex-col gap-[50px] w-full  bg-gray-800">
    ...
    <ul className=" text-end   text-sm font-medium text-gray-400 dark:text-gray-400 sm:mt-0">
        <li className="text-lg font-bold mb-3  text-gray-300"> MERTY inspiration 5 </li>
      {
    ...
    <h3 className="text-lg font-bold mb-3 text-gray-300">Contact us</h3>
    ...
    <h3 className="text-lg font-bold  text-gray-300">Follow us </h3>
