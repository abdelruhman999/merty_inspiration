...
const CashierSystem: FC = () => {
    ...
    } = useForm<CustomerData>({ defaultValues: { is_paid: false } });
    ...
    `,
            ...
            customClass: {
                confirmButton:
                    "bg-green-500 hover:bg-green-600 text-white font-medium py-2 px-4 rounded-md",
                cancelButton:
                    "bg-gray-300 hover:bg-gray-400 text-gray-800 font-medium py-2 px-4 rounded-md mr-2",
            },
        });
        ...
        try {
            const res = await sendRequest<CustomerData>({
            ...
            console.log(res);
            setCustmorValue("order_id", res.order_id);
            setCustmorValue("is_paid", res.is_paid);
...
`;
    ...
    useEffect(()=>{
        if(cart.length> 0){
            ...
            const totalWithDiscount = (supPrice + deliveryPrice) - watchCustomer("custom_discount");
                        ...
                        <div className="mb-3">
                            ...
                            <ul className={style.wrapper}>
                                ...
                                <li
                                    ...
                                    className={`${style.icon} ${style.tiktok} ${
                                        order.source === "TIKTOK"
                    ...
                    <div className=" flex flex-col gap-[10px]">
                        <div className="flex  gap-5 pt-4">
                            <span
                                ...
                                className={`px-3 hover:scale-110 ${
                                    order.type === "COD"
                                        ? "scale-110 shadow border border-purple-800  "
                                        : "scale-90"
                                } duration-200 cursor-pointer py-1.5 rounded-full text-sm bg-purple-100 text-purple-800 border border-purple-200 flex items-center gap-1.5`}
                            >
                            ...
                            <span
                                ...
                                className={`px-3 hover:scale-110 ${
                                    order.type === "ONLINE"
                                        ? "scale-110 shadow border border-emerald-800 "
                                        : "scale-90"
                                } duration-200 cursor-pointer py-1.5 rounded-full text-sm bg-emerald-100 text-emerald-800 border border-emerald-200 flex items-center gap-1.5`}
                            >
                                🌐 ONLINE - دفع إلكتروني
                            </span>
                            ...
                            <span
                                ...
                                className={`px-3 hover:scale-110 ${
                                    order.type === "HOTSPOT"
                                        ? "scale-110 shadow border border-amber-800 "
                                        : "scale-90"
                                } duration-200 cursor-pointer py-1.5 rounded-full text-sm bg-amber-100 text-amber-800 border border-amber-200 flex items-center gap-1.5`}
                            >
                                📶 HOTSPOT - دفع محلي
                            </span>
                        </div>
